"""
Django settings for groupchat_42444 project.
...
ROOT_URLCONF = 'groupchat_42444.urls'
...
WSGI_APPLICATION = 'groupchat_42444.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "groupchat_42444 API",
    "DESCRIPTION": "API documentation for groupchat_42444 App",
    "VERSION": "v1",
}
